...
document.addEventListener("DOMContentLoaded", () => {
    ...
    widget.innerHTML = `
        ...
        <div class="cu-chat__panel" id="cuChatPanel" role="dialog" aria-label="Atendimento virtual Crazy Up" aria-hidden="true">
            <header class="cu-chat__header">
                <span class="cu-chat__avatar">
                    <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=160&q=85" alt="Atendente Crazy Up">
                </span>
    ...
    if (promotionForm) {
        ...
        const promotionLoader = document.getElementById("promotionLoader");
        const submitButton = promotionForm.querySelector("button[type=submit]");
        const PROMO_CODE = "LOSPOTATOSCPV";
        const CRAZYUP_WHATSAPP = WHATSAPP_NUMBER;
        ...
        promotionForm.addEventListener("submit", (event) => {
            ...
            promotionLoader.classList.add("is-visible");
            promotionLoader.setAttribute("aria-hidden", "false");
            ...
            ticketWhatsapp.href = `https://wa.me/${CRAZYUP_WHATSAPP}?text=${encodeURIComponent(ticketMessage)}`;
            ticketWhatsapp.dataset.ticketMessage = ticketMessage;
            submitButton.disabled = false;
            submitButton.removeAttribute("aria-busy");
            promotionLoader.classList.remove("is-visible");
            promotionLoader.setAttribute("aria-hidden", "true");
            }, 900);
        });
        ...
        ticketWhatsapp.addEventListener("click", async (event) => {
            ...
            window.open(`https://wa.me/${CRAZYUP_WHATSAPP}?text=${encodeURIComponent(ticketWhatsapp.dataset.ticketMessage)}`, "_blank", "noopener");
        });
    }
});
